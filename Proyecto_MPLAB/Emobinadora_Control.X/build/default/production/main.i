...
int estado;
_Bool TMR2_flag, TMR4_flag;
int L, AWG, capas, sel_vel;
int diametro;
long tension;
int char_leido;
    ...
    while (1) {
        ...
        switch (estado) {
            ...
            case 7:
                ...
                if ((promedio < gramo_abajo) && (clockwise == 1))
                {
                    pwm --;
                    if(pwm < 400)
                    {
                ...
                }else if ((promedio > gramo_arriba) && (clockwise == 1))
                {
                    pwm++;
                    if(pwm > 800)
                        pwm = 800;
                ...
                if ((promedio < gramo_abajo) && (clockwise == 0))
                {
                    pwm --;
                    if(pwm < 0)
                    {
                ...
                }else if ((promedio > gramo_arriba) && (clockwise == 0))
                {
                    pwm++;
                    if(pwm > 400)
                        clockwise = 1;
